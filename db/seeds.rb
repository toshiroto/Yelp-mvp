...
waku-waku = { name: 'Waku Waku', address: '51-3 Kawadacho, Shinjuku, 154-0052', phone_number: '030-3092-0339', category: 'japanese' }
chilovesyou = { name: 'chilovesyou', address: '12-3, Harajuku, Shibuya, 151-0032', phone_number: '030-3022-0339', category: 'french' }
le-chocolat = { name: 'Le chocolat', address: '20-3, Omotesando, Shibuya, 151-0032', phone_number: '080-3022-0339', category: 'belgian' }
